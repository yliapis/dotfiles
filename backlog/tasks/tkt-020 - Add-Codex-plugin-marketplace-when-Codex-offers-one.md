...
Codex plugin marketplace is in the repo: per-plugin `.codex-plugin/plugin.json`, repo catalog `.agents/plugins/marketplace.json`, and home-dir dest_plugin_dir on the agents target.
