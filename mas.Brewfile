# Mac App Store — installed via install.sh when BREW_BUNDLE_MAS=1.
...
# Closed-display keep-awake; App Store only (no Homebrew cask).
...
# Punch Through BLE browser; App Store only (no Homebrew cask).
