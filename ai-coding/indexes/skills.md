...
| 9 | `minimal-diffs` | `ai-coding/plugins/git-operations/skills/minimal-diffs/SKILL.md` | no | Apply minimal, surgical changes when creating, editing, modifying, refactoring, or fixing any... |
| 10 | `prompt-template-library` | `ai-coding/plugins/writing/skills/prompt-template-library/SKILL.md` | yes | Pick a starting skeleton from the prompt template library when an agent is drafting a new... |
| 11 | `simple-english` | `ai-coding/plugins/writing/skills/simple-english/SKILL.md` | no | Write or rewrite technical text with the rules of ASD-STE100 Simplified Technical English so it... |
| 12 | `stop-slop` | `ai-coding/plugins/writing/skills/stop-slop/SKILL.md` | no | Remove AI writing patterns from prose. Use when drafting, editing, or reviewing text to... |
| 13 | `ticket-crud` | `ai-coding/plugins/ticket-operations/skills/ticket-crud/SKILL.md` | yes | Create a new local Markdown ticket set and WORKLIST.md from an analysis, review, plan, or... |
| 14 | `ticket-execute` | `ai-coding/plugins/ticket-operations/skills/ticket-execute/SKILL.md` | yes | Execute open runnable tickets from a native local Markdown ticket set, verify acceptance with... |
| 15 | `trajectory-snapshot` | `ai-coding/plugins/session-state/skills/trajectory-snapshot/SKILL.md` | yes | Snapshot the current agent session's trajectory into a file at a chosen granularity — verbatim... |
| 16 | `worktree-task` | `ai-coding/plugins/orchestration/skills/worktree-task/SKILL.md` | yes | Launch agents in isolated git worktrees to execute a task end-to-end, then present per-worktree... |
...
```text
agent-swarm, artifact-researcher, conventional-commits, design-skill, designer, excalidraw-diagrams, file-dump, flint-chart-author, minimal-diffs, prompt-template-library, simple-english, stop-slop, ticket-crud, ticket-execute, trajectory-snapshot, worktree-task
```
