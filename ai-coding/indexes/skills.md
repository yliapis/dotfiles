...
| 3 | `crud-tickets` | `ai-coding/plugins/ticket-operations/skills/crud-tickets/SKILL.md` | yes | Create a new local Markdown ticket set and WORKLIST.md from an analysis, review, plan, or... |
...
```text
agent-swarm, conventional-commits, crud-tickets, design-skill, designer, file-dump, minimal-diffs, prompt-template-library, stop-slop, ticket-execute, trajectory-snapshot, worktree-task
```
...
ai-coding/plugins/ticket-operations/skills/crud-tickets/SKILL.md
