...
| `test_command` | [constraints](concerns/constraints.md) | `verify_command` | worktree-task, agent-swarm, ticket-execute |
...
| `write_gate` (family) | [lifecycle](concerns/lifecycle.md) | `update_mode`, `persistence`, `dry_run`, `mode` | meta-prompt, ralph-design, design-skill, designer-controller, ticket-create, ticket-execute, ticket-update, save-session-state |
...
| `approval_mode` | [interaction](concerns/interaction.md) | `mode` | ticket-execute, ticket-update, ralph-design, agent-swarm |
